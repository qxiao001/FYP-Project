...
/*    public static String updateMaxSQLPath = projectFolder + "updateMax.sql";
    ...
    public static String updateCombfinaltsSQLPath = projectFolder + "updateCombfinalts.sql";*/
    
    public static String updateMaxSQLPath = "updateMax.sql";
    public static String updateMinSQLPath =  "updateMin.sql";
    public static String indivChilllerSQLPath =  "indivChillerJoin.sql";
    public static String combChilllerSQLPath =  "combChillerJoin.sql";
    public static String finalChilllerSQLPath =  "finalChillerJoin.sql";
    public static String indivSelectSQLPath = "indivSelect.sql" ;
    public static String indivSelect2SQLPath =  "indivSelect2.sql" ;
    public static String updateCombfinaltsSQLPath =  "updateCombfinalts.sql";
